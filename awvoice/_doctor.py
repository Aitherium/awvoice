"""Stack-aware `doctor` for awvoice.
...
interesting failures live BETWEEN them. "awvoice is installed" is not the useful
fact -- "awvoice is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWVOICE_STT_URL', 'AWVOICE_TTS_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awvoice needs at runtime, and a
